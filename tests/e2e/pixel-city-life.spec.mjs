...
test.describe("慢速圖片的確認操作", () => {
  // A service worker can fulfill images before page.route sees the request.
  // Isolate just this delayed-image scenario; ordinary city flows and the
  // dedicated offline/update suites retain their real service workers.
