export default[
 ...
 {files:["**/*.{js,mjs}"],languageOptions:{ecmaVersion:"latest",sourceType:"module",globals:{
  ...
  console:"readonly",process:"readonly",Buffer:"readonly",TextEncoder:"readonly",structuredClone:"readonly",performance:"readonly",getComputedStyle:"readonly",setTimeout:"readonly",clearTimeout:"readonly",setInterval:"readonly",clearInterval:"readonly"
 }},rules:{
  "no-undef":"error",
