const CACHE="star-game-runtime-v1.40.0";
...
const SHELL=["./pixel.html","./pixel.css","./pixel-ui.css","./pixel-apps.css","./pixel-theme.css","./phone.css","./assets/fonts/Cubic_11.woff2","./pixel.webmanifest","./pixel-offline.json","./","./index.html","./classic.html","./src/entry.js","./cascade.css","./legacy-foundation.css","./legacy-onboarding-settings.css","./legacy-career-agency.css","./legacy-people-wardrobe.css","./legacy-world-social.css","./legacy-career-feedback.css","./legacy-world-creative.css","./legacy-progression.css","./legacy-story-gallery.css","./legacy-late-passes.css","./ui-hardening.css","./design-system.css","./components-feedback.css","./a11y.css","./runner-flow.css","./audio.css","./browser-flow.css","./city-life.css","./scene-ui.css","./assets/city/starwish-city-soft.jpg","./src/main.js","./assets/rookie-room.webp","./assets/icons/app-icon.svg","./assets/icons/favicon-32.png","./assets/icons/apple-touch-icon.png","./assets/icons/icon-192.webp","./assets/icons/icon-512.webp","./manifest.webmanifest",...AUDIO_SHELL];
