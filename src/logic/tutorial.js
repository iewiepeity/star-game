export const TUTORIALS=[
 {id:"room-welcome",when:s=>s.screen==="game"&&!s.appOpen,kicker:"新人手冊・第一步",title:"點房間裡的物件",text:"窗外通往星望市，平板安排日程，手機查看近況。先跟著便條，找一個想去的地方。"},
 ...
 {id:"map-basics",when:s=>s.screen==="game"&&s.appOpen==="map",kicker:"新人手冊・探索",title:"自由活動要有目的地",text:"移到建築看介紹與線索，點選後再安排日期。手機和平板可以滑動地圖、點建築預覽；確認前往後才會排入行程。"},
