export const TUTORIALS=[
 ...
 {id:"npc-basics",when:s=>s.screen==="game"&&s.appOpen==="people"&&s.peopleSection==="profiles"&&s.knownPeople?.length,kicker:"經紀人小抄・人際",title:"關係藏在相處裡",text:"好感與交惡數值不會直接顯示。多次見面、主動相處與合作會開啟專屬事件；踩到底線，愛心也可能當場碎給你看。"},
