...
export const LIFE_EVENTS={
 train:[
  ...
  {id:"train_peer",title:"隔壁練習生進步得太快",text:"上週還會一起卡拍的人，今天忽然像換了一個人。你忍不住開始比較。",choices:[{id:"ask",label:"直接問他怎麼練的",outcome:"你拿到一套很實際的練習方法。",effect:{stat:"學習",value:3,hidden:"自律",value:1}},{id:"compete",label:"今天一定要追上",outcome:"效果有，但明天大概會鐵腿。",effect:{stat:"肢體表現",value:3,fatigue:5}}]},
  {id:"train_teacher_note",title:"老師把你單獨留下",text:"課後老師沒有立刻走，只把你的練習影片重新播了一遍。",choices:[{id:"listen",label:"把批評全部聽完",outcome:"有些話很刺，但確實打中問題。",effect:{rep:"業界評價",value:2,hidden:"抗壓",value:2}},{id:"question",label:"追問具體改善方法",outcome:"你拿到下一週可以執行的練法。",effect:{hidden:"自律",value:2}}]},
 ...
 job:[
  ...
  {id:"job_rewrite",title:"開拍前五分鐘改稿",text:"新的台詞剛送到手上，連標點都還帶著修訂痕跡。",choices:[{id:"memorize",label:"先把內容穩穩記住",outcome:"至少正式拍攝沒有卡詞。",effect:{hidden:"抗壓",value:2}},{id:"ask",label:"先確認導演真正要的情緒",outcome:"你沒有死背，而是抓到了修改原因。",effect:{hidden:"洞察",value:2,rep:"業界評價",value:1}}]},
  ...
  {id:"job_interview",title:"收工突然多了一個短訪",text:"宣傳組臨時問你能不能補錄兩分鐘幕後訪談。沒有題綱。",choices:[{id:"accept",label:"直接上",outcome:"一段自然的回答被剪進宣傳花絮。",effect:{stat:"口才",value:2,rep:"話題度",value:2}},{id:"prepare",label:"先要三分鐘整理一下",outcome:"回答比較完整，也沒有說錯話。",effect:{rep:"可信度",value:2}}]},
 ...
 life:[
  ...
  {id:"daily_invitation",title:"突然收到一張活動邀請函",text:"不是正式工作，只是一場圈內小型聚會。去不去都不會有人怪你。",kind:"職涯事件",requires:{fameMin:60},choices:[{id:"go",label:"露個臉",outcome:"你交換了幾張名片，也聽見一些還沒公開的企劃。",effect:{stat:"社交",value:2,rep:"業界評價",value:2,fatigue:2}},{id:"home",label:"今晚留給自己",outcome:"錯過一點人脈，換到一點安靜。",effect:{mood:4,fatigue:-3}}]},
