...
export const LIFE_EVENTS={
 train:[
  ...
  {id:"train_peer",title:"隔壁練習生進步得太快",text:"上週還會一起卡拍的人，今天忽然像換了一個人。你忍不住開始比較。",choices:[{id:"ask",label:"直接問他怎麼練的",outcome:"你拿到一套很實際的練習方法。",effects:[{stat:"學識",value:3},{hidden:"自律",value:1}]},{id:"compete",label:"今天一定要追上",outcome:"效果有，但明天大概會鐵腿。",effect:{stat:"肢體表現",value:3,fatigue:5}}]},
