// 玩家立繪與衣櫃資料。四種外型與三套服裝都有完整對應圖，不以性別限制選擇。
export const AVATARS={
 silver:{id:"silver",name:"霧銀系",tagline:"安靜、精緻，帶一點夢幻距離感",genderHint:"女性立繪"},
...
export const portraitAsset=(avatarId,outfitId)=>`./assets/avatars/${AVATARS[avatarId]?avatarId:"silver"}-${OUTFITS[outfitId]?outfitId:"newcomer"}.webp`;
