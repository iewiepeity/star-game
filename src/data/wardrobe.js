// 玩家立繪與衣櫃資料。每種外型、每套服裝都有獨立立繪與縮圖，服裝可連同髮型一起變化。
...
export const OUTFITS={
 ...
 casual:{id:"casual",name:"週末休閒套裝",price:1600,note:"不刻意搶鏡的舒服搭配，適合生活節目與社群曝光。",bonuses:{親和力:8,社交:4}},
 street:{id:"street",name:"街頭機能造型",price:2600,note:"活動度高又有辨識度，適合外景、舞蹈與街頭企劃。",bonuses:{肢體表現:7,時尚:6}},
 classic:{id:"classic",name:"經典試鏡正裝",price:3200,note:"乾淨、專業、不搶角色，特別適合戲劇與主持試鏡。",bonuses:{鏡頭感:7,儀態:6}},
 vocal:{id:"vocal",name:"錄音室舒適穿搭",price:2400,note:"長時間錄音也不妨礙呼吸與發聲，讓聲音工作更穩。",bonuses:{聲線:7,歌藝:5}},
 variety:{id:"variety",name:"綜藝亮色套裝",price:3900,note:"鏡頭上有存在感但不會過度正式，適合棚內與外景綜藝。",bonuses:{主持:7,口才:6,親和力:4}},
 cinema:{id:"cinema",name:"演員質感套裝",price:4200,note:"線條簡潔、情緒不被服裝吃掉，適合戲劇與電影場合。",bonuses:{演技:7,鏡頭感:6,氣質:3}},
 editorial:{id:"editorial",name:"時尚編輯造型",price:5800,note:"輪廓強、辨識度高，適合品牌拍攝、看秀與雜誌企劃。",bonuses:{時尚:10,外貌:5}},
 premium:{id:"premium",name:"精品活動禮服",price:8200,note:"高端品牌與紅毯場合的正式配置，商務活動更有說服力。",bonuses:{氣質:10,儀態:8,時尚:5}},
 host:{id:"host",name:"典禮主持正裝",price:6800,note:"兼顧正式感與活動度，長時間直播主持也能維持穩定氣場。",bonuses:{主持:9,口才:6,儀態:5}},
 icon:{id:"icon",name:"個人標誌造型",price:12000,note:"不是最安全的穿法，但如果撐得住，就很難被忘記。",bonuses:{時尚:12,鏡頭感:8,氣質:5}}
};
