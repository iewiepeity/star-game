...
export const MAP_LOCATIONS={
 radio:{name:"星望廣播電臺",area:"傳媒區",category:"演藝",icon:"聲",note:"節目錄音、主持與業界人士出入的地方。",effect:"口才／社交・可能遇見喬映澄",gain:["口才",3,6],encounter:"jiqing"},
 livehouse:{name:"月蝕 Live House",area:"舊城區",category:"演藝",icon:"樂",note:"地下歌手與新人樂團聚集的小型展演空間。",effect:"歌藝／靈感・可能遇見江敘白",gain:["靈感",4,8],bonus:["歌藝",2,4],encounter:"lujingran"},
 cinema:{name:"星輝電影院",area:"文化街區",category:"靈感",icon:"戲",note:"獨立電影與院線片都會上映的老戲院。",effect:"靈感／演技・可能遇見裴硯之",gain:["靈感",3,7],bonus:["演技",1,3],encounter:"shenyao"},
 studio:{name:"十七號攝影棚",area:"影視園區",category:"演藝",icon:"影",note:"廣告、戲劇與綜藝經常在此錄製。",effect:"鏡頭感／社交・可能遇見宋知夏",gain:["鏡頭感",3,6],bonus:["社交",1,3],encounter:"xiayutong"},
 recording:{name:"迴聲錄音室",area:"音樂園區",category:"演藝",icon:"錄",note:"專輯、配唱與廣告歌曲的專業錄音空間。",effect:"歌藝／聲線・可能遇見楚星梨",gain:["聲線",3,7],bonus:["歌藝",2,4],encounter:"tangtang"},
 rehearsal:{name:"映畫排練室",area:"影視園區",category:"演藝",icon:"排",note:"演員與舞者租用的排練空間，牆上貼滿試鏡通知。",effect:"演技／肢體表現・可能遇見許映真",gain:["演技",4,7],bonus:["肢體表現",2,4],encounter:"sufei"},
 theatre:{name:"星河小劇場",area:"劇場街區",category:"演藝",icon:"劇",note:"舞臺劇與演員工作坊輪番登場，後臺總有意外的交流。",effect:"演技／口才・可能遇見周予珩",gain:["演技",3,7],bonus:["口才",1,3],encounter:"guchengxi"},
 gallery:{name:"白牆藝廊",area:"藝文街區",category:"靈感",icon:"藝",note:"攝影展與品牌企劃常在此舉行。",effect:"鏡頭感／時尚・可能遇見溫時嶼",gain:["時尚",3,6],bonus:["鏡頭感",1,3],encounter:"chengyian"},
 ...
 business:{name:"星環商務中心",area:"商業區",category:"演藝",icon:"務",note:"經紀公司、品牌與製作公司密集的大樓群。",effect:"社交／口才・可能遇見秦紹謙",gain:["社交",3,6],bonus:["口才",1,3],encounter:"hanzhiyuan"},
