...
export function timelineItems(){
 ...
 const works=(state.completedWorks||[]).map((x,index)=>({id:`work-${index}`,week:x.completedWeek||x.week,group:"works",type:"作品",title:`《${x.title}》`,text:x.storyLegacy||`${x.category||"作品"}已進入履歷。`,target:"world"}));
