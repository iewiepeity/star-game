...
export function timelineItems(){
 ...
 const events=(state.eventHistory||[]).map((x,index)=>({id:`event-${index}`,week:x.week,group:"decisions",type:x.kind||"重大選擇",title:x.title,fullText:x.text,text:`你選擇了「${x.choiceLabel||"確認"}」${x.outcome?`；${x.outcome}`:""}`,target:"planner"}));
