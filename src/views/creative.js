...
function projectCard(p) {
  const def = CREATIVE_TYPES[p.type],
    ...
    step = phase(p);
  const story = CREATIVE_DIRECTION_STORIES[p.type]?.[p.direction];
