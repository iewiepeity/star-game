...
export function peopleApp() {
  ...
  if (!known.length) return `<div class="inside-page"><div class="inside-title"><div><span>CONTACTS</span><h2>手機通訊錄</h2></div><p>0 位聯絡人</p></div><div class="tablet-empty"><span>♡</span><h3>還沒有認識任何人</h3><p>安排自由活動或參加工作，與遇見的人交換聯絡方式。</p><button data-go-free>去安排自由活動</button></div></div>`;
