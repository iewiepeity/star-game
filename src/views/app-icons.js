// 平板 App 圖示：同一套 24px 圓角線條 SVG，避免字型符號在不同裝置跑版。
const paths={
 ...
 people:'<path d="M12 21S3 16 3 9.5A4.5 4.5 0 0 1 11 6.7L12 8l1-1.3a4.5 4.5 0 0 1 8 2.8C21 16 12 21 12 21Z"/><circle cx="8" cy="10" r="1"/>',
...
export const APP_META=Object.freeze({
 planner:{label:"行程",title:"行程與工作",note:"安排七天行程、策略與預算",tone:"coral"},timeline:{label:"時間線",title:"星途時間線",note:"集中查看人物、作品與重大選擇",tone:"amber"},gallery:{label:"影像館",title:"星途影像館",note:"收藏 CG 並重讀人物章節",tone:"violet"},stats:{label:"能力",title:"能力資料",note:"檢視能力與隱藏特質",tone:"blue"},people:{label:"人際",title:"手機與人際",note:"查看聯絡人和關係進度",tone:"rose"},log:{label:"紀錄",title:"星途紀錄",note:"回顧每週成果與重大選擇",tone:"slate"},world:{label:"娛樂週報",title:"娛樂圈週報",note:"市場、作品與後台世界",tone:"indigo"},map:{label:"星望地圖",title:"星望市地圖",note:"探索城市與產業公司",tone:"sage"},jobs:{label:"工作信箱",title:"工作信箱",note:"管理徵選、推薦與指名邀約",tone:"gold"},creative:{label:"創作室",title:"創作工作室",note:"製作、販售或自主發行作品",tone:"plum"},npc:{label:"人物檔案",title:"人物檔案",note:"已認識人物的資料與關係",tone:"teal"},social:{label:"星光社群",title:"星光社群",note:"發布近況並查看圈內動態",tone:"pink"},forum:{label:"星談論壇",title:"星談論壇",note:"娛樂討論與熱門話題",tone:"orange"},wardrobe:{label:"造型衣櫃",title:"造型衣櫃",note:"切換造型與能力加成",tone:"lilac"},agency:{label:"經紀公司",title:"經紀公司",note:"投遞、面談與簽約進度",tone:"navy"},achievements:{label:"星途成就",title:"星途成就",note:"收藏旅程與生活里程碑",tone:"honey"},save:{label:"存檔管理",title:"存檔管理",note:"管理存檔與安全備份",tone:"mint"},settings:{label:"遊戲設定",title:"遊戲設定",note:"存讀檔、顯示與遊戲流程",tone:"gray"}
});
export const APP_LIBRARY_IDS=Object.freeze(["planner","timeline","gallery","stats","people","log","world","map","jobs","creative","npc","social","forum","wardrobe","agency","achievements","save","settings"]);
export const APP_DOCK_IDS=Object.freeze(["planner","timeline","gallery","stats","people","log"]);
export function appIcon(id,className=""){return`<svg class="app-icon-svg ${className}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${paths[id]||paths.settings}</svg>`}
