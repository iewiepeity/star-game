...
export function normalizeDockIds(ids,{fallback=true}={}){const clean=[...new Set((Array.isArray(ids)?ids:[]).filter(id=>APP_LIBRARY_IDS.includes(id)))].slice(0,6);return clean.length||!fallback?clean:[...DEFAULT_DOCK_IDS]}
