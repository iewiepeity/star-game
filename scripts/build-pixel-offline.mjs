...
const paths=["index.html","pixel.html","pixel.css","pixel-ui.css","pixel-apps.css","pixel-theme.css","phone.css","pixel.webmanifest",...(await walk("src/")).filter(p=>p.endsWith(".js")),...(await walk("assets/")).filter(p=>/\.(webp|jpg|jpeg|png|svg|ogg|js|json|woff2|txt)$/i.test(p))];
