...
assert(bIds.length===25,`B 級特色工作應為 25，實際 ${bIds.length}`);
assert(new Set([...aIds,...bIds]).size===40,"A／B 工作不得重疊");
...
assert(cCount===35,`C 級工作應為 35，實際 ${cCount}`);
...
console.log(`垂直深化驗證通過：15 A 級旗艦、25 B 級特色、${cCount} C 級基礎工作；10 NPC 各八章主線與專屬戀愛聲音均完整。`);
